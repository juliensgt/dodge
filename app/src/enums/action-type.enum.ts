export enum ActionType {
  ...
  SWITCH_FROM_DECK_TO_DEFAUSSE = "SWITCH_FROM_DECK_TO_DEFAUSSE",
  SWITCH_FROM_DECK_TO_PLAYER = "SWITCH_FROM_DECK_TO_PLAYER",
  SWITCH_FROM_DEFAUSSE_TO_PLAYER = "SWITCH_FROM_DEFAUSSE_TO_PLAYER",
